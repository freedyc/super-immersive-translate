...
import { Card, SelectField } from '../components/Field.tsx';
import { ENGINES, ENGINE_NAMES } from '../../utils/translation-options.ts';
import type { TabProps } from '../lib/types.ts';

export function SitesTab({ settings, update }: Pick<TabProps, 'settings' | 'update'>) {
  ...
  const removeSiteEngine = (host: string) => {
