...
export const SELECTION_ENGINE_OPTIONS = [
...
export const COLORS = ['#9b59b6', '#4f8ef7', '#7c8aaa', '#27ae60', '#e67e22', '#e74c3c', '#00b894'];
...
export const AI_ENGINES = ['openai', 'gemini', 'claude', 'ollama', 'webllm', 'custom'];
