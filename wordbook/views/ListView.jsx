...
function SpeakButton({ text, lang, title }) {
  return (
    <button
...
function WordCard({ word, onDelete, onRegenerate }) {
...
export function ListView({ words, totalCount, onDelete, onRegenerate }) {
  if (totalCount === 0) {
    return (
...
export async function regenerateExample(word, updateWord) {
